...
struct VersionInfo {
  constexpr VersionInfo(unsigned int maj, unsigned int min, unsigned int alp)
...
template <>
struct VkStructSetter<VkApplicationInfo, EngineVersion, AppVersion,
                      std::uint32_t, const_str, const_str> {
  static void set(VkApplicationInfo &appInfo, const EngineVersion &e,
